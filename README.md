...
> Starting with patches v3.0.0, SR7 patches use [Morphe](https://morphe.software).
...
```sh
java -jar cli.jar patch --patches sr7 patch v3.mpp input.apkm
```
...
<!-- PATCHES_START -->
> **[v3.8.0](demo)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;128 patches total
<details>
...
To build SR7 Patches, follow the [Morphe documentation](https://github.com/MorpheApp/morphe-documentation).
...
#Made by [SR7 Mods](https://t.me/sr7mods)
